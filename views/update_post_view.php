    ...
    <div class="flex-grow text-gray-100">
        ...
        <div class="flex-grow p-8">
            <div id="postFormsContainer">
                ...
                <!-- Inside update_post_view.php -->
                <div class="flex-grow p-8">
                    <h1 class="font-medium text-3xl mb-4 text-black">Update Post</h1>
                    <form id="updatePostForm" class="bg-white p-6 rounded shadow">
                        <input type="hidden" id="postId" name="postId">
                        <div>
                            <label for="userId" class="text-sm text-gray-700">User ID</label>
                            <input type="number" id="userId" name="userId"
                                class="bg-gray-100 border border-gray-200 rounded py-2 px-3 w-full mb-3 text-black" required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <textarea id="body" name="body"
                                class="bg-gray-100 border border-gray-200 rounded py-2 px-3 w-full text-black" required></textarea>
                        </div>
                        <button type="submit"
                            class="py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-600 mt-3">Update Post</button>
                    </form>
                </div>
                <script>
