...
<body class="flex bg-gray-100 min-h-screen">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
    ...
    <!----   navbar    --->
    <button onclick="location.href='add_post.php'" class=" mt-3 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">Add post</button>
    <section class="py-6 sm:py-12 dark:text-gray-100">
  <div class="container p-6 mx-auto space-y-8">
    <div class="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4" id="product-container">
		</div>
	</div>
</section>
  </div>
