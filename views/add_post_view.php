...
<body class="flex bg-gray-100 min-h-screen">
    ...
    <div class="flex-grow text-gray-100">
        ...
        <div class="flex-grow p-8">
            <h1 class="font-medium text-3xl mb-4">Add Post</h1>
            <div id="postFormsContainer">
                <!-- Single Post Form Template -->
                <form class="postForm bg-white p-6 rounded shadow mb-4">
                    <div>
                        <label for="userId" class="text-sm text-gray-700">User ID</label>
                        <input type="number" name="userId"
                            class="bg-gray-100 border border-gray-200 rounded py-2 px-3 w-full mb-3"
                    ...
                    <div>
                        ...
                        <textarea name="body" class="bg-gray-100 border border-gray-200 rounded py-2 px-3 w-full"
                            placeholder="Enter Post Content" required></textarea>
                    </div>
                    <button type="submit" class="py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-600 mt-3">Save
                        Post</button>
                </form>
            </div>
            <button id="addMorePosts" class="py-2 px-4 bg-green-500 text-white rounded hover:bg-green-600">Add More
                Posts</button>
        </div>
        <script>
            document.getElementById('addMorePosts').addEventListener('click', function () {
                const container = document.getElementById('postFormsContainer');
